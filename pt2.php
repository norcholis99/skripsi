...
<div class="wrapper">
  ...
  <tbody>
    ...
    <?php 
      ...
      $sql=mysqli_query($kon,"select * from piutang2 where no_faktur like '%".$cari."%' or nama_pelanggan like '%".$cari."%' order by no_faktur asc ");
    } else {$sql = mysqli_query($kon,"select * from piutang2 order by no_faktur asc");
      }
