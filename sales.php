...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <div class="header">
      ...
      <h4> &nbsp Laporan Kunjungan Marketing<br> &nbsp PT. Megah Medika Pharma Cabang Banjarmasin</h4>
    </div>
  ...
  <div class="modal" tabindex="-1" role="dialog" id="mdl">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Input Laporan Kunjungan Harian</h5>
      ...
      <form method="POST" action="sales_tambah.php">
          ...
          <div class="form-group row mt-3">
            <label class="col-sm-4 col-sm-label">Hasil Kunjungan</label>
  ...
  <tbody>
    ...
    <?php 
      ...
      $sql=mysqli_query($kon,"select * from sales where rumahsakit like '%".$cari."%' or ruangan like '%".$cari."%' or user like '%".$cari."%' order by no  asc ");
    } else {$sql = mysqli_query($kon,"select * from sales order by no asc");
      }
      ...
      <tr>
        ...
        <td style="text-align: center;">
          ...
          <a class="edit.record" href="#" data-target="#md2" data-toggle="modal" data-id=<?php echo $saa ['no'] ; ?>>
            <i class="nav-icon fas fa-key text-info"></i>
          </a>&nbsp&nbsp
          
          <a href="sales_hapus.php?id=<?php echo $saa ['no'];?>">
    ...
    <tr>
      ...
      <div class="modal fade" tabindex="-1" role="dialog" id="md2">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Edit Laporan Kunjungan</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
                </div>
...
<script>
  ...
  $("#rumahsakit").keyup(function(event){
    if (event.which == 13 || event.keycode == 13){
      $("#ruangan").focus();
    }
  });
  $("#ruangan").keyup(function(event){
    if (event.which == 13 || event.keycode == 13){
      $("#user").focus();
    }
  });
