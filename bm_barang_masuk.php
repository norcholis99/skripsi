  ...
  <div class="content-wrapper">
	...
	<tbody>
		<?php 
			...
			$sql=mysqli_query($kon,"select * from barang_masuk where no_register like '%".$cari."%' or tanggal like '%".$cari."%' or kode_barang like '%".$cari."%' or nama_barang like '%".$cari."%' order by no asc ");
		} else {$sql = mysqli_query($kon,"select * from barang_masuk order by no asc");
			}
